  ...
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <div class="pt-24">
      ...
      <div class="content7">
          ...
          <div class="content8">
            <h4 class ="t3">Here to Provide a Home</h2>
          <p class="t4">24 Hours a day 7 Days a week 365 Days a year</p>
          <button class ="button2" onClick="window.location.href='geolocation.php';" class="button1">Find Home</button>
        </div>
        <div class="content9">
          <img class="img" src="house.png">
        </div>
        </div>
    ...
    <section class="bg">
      <div class="spe">
                  ...
                  <div class="row">
                    ...
                    <div class="content6">
                      <h2 class ="t1">Find something near you</h2>
                    <p class="t2">Find a home around you, or where you would like to move to</p>
                    
                  </div>
                  <div class="content6">
                    <img class="img" src="move.png">
                  </div>
                  </div>
                  <div class="content4">
                    <div class="content6">
                      <img class="img" src="tour.png">
                  </div>
                  <div class="content6">
                    <h2 class ="t1">Hassle free tour</h2>
                    <p class="t2">After finding the house, sign a legal liability agreement, get sent a digital key, scan key at house to unlock, and tour all by yourself!
                    </p>
                  ...
                  <div class="content4">
                    ...
                    <div class="content6">
                      <h2 class ="t1">Screening</h2>
                    <p class="t2">Submit w2's, background check, license, and wait for an email.</p>
                    
                  </div>
                  <div class="content6">
                    <img class="img" src="id.png">
                  </div>
                  </div>
                  <div class="content4">
                    <div class="content6">
                      <img class="img" src="guymove.png">
                  </div>
                  <div class="content6">
                    <h2 class ="t1">Move in</h2>
                    <p class="t2">After the email from screening, sign a lease, and move in!</p>
                  </div>
                  </div>
                  <div class="content10">
                    <h1 class="ready">
                    ...
                    <button class ="button3" onClick="window.location.href='geolocation.php';">Find Home</button>
                  </div>
