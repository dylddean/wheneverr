  ...
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <div class="pt-20">
      ...
      <div class="spe">
                  ...
                  <div class="content4">
                    <div class="content6">
                      <img class="img" src="payment.png">
                  </div>
                  <div class="content6">
                    <h2 class ="t1">Make a Payment</h2>
                    <p class="t2">Fullfill a rental payment, rent to own, or auto loan.</p>
                    <button onClick="window.location.href='auto.php';" class="button1">Make Payment</button>
                  </div>
