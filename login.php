      ...
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        ...
        <div class="top">
          ...
          if (isset($_SESSION["useruid"])) {
            echo "<span li class='sign'><a href='dash.php'>Profile Page</a></li>";
            echo "<span li class='sign'><a href='logout.php'>Logout</a></li>";
          }
          else {
    ...
    <div class="pt-20">
      ...
      <div class="spe">
                  ...
                  <div class="row">
                    ...
                    <div>
                    <button class="button1" type="submit" name="submit">Login</buttton>
                    <div>
                    </div>
                    </section>
                    <section class="bg">
              ...
              if ($_GET["error"] == "emptyinput") {
                echo "<span class='p1'><p1>Fill in all fields!</p1>";
              }
              elseif ($_GET["error"] == "wronglogin") {
                echo "<span class='p1'><p1>Incorrect login information!</p1>";
              }
