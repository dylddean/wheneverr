    ...
    <section class="bg-white">
          ...
          <div class='content1'>
            <div class="content4">
              ...
              <input type="text" placeholder="Your phone number" id="location"/>
              <input type="text" placeholder="Your address" id="location"/>
              <input type="text" placeholder="Price" id="locality"/>
              <input type="text" placeholder="Make" id="locality"/>
              <input type="text" placeholder="Model" id="locality"/>
              <input type="text" placeholder="Year" id="locality"/>
