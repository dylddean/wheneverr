...
<script nomodule src="https://unpkg.com/ionicons@5.5.2/dist/ionicons/ionicons.js"></script>
    ...
    <link rel="stylesheet" href="coming soonn.css">
  </head>
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <div class="pt-20">
      ...
      <p class="loantext">
            Hi, this is Dylan Dean, founder of WheneverHome you've encountered a page that has not been set up yet, sorry for the inconvenience!
          </p>
                  <div class="row">
                    <div class="content4">
                    <p class="lets">
          ...
          <div>
          <button onClick="window.location.href='index.php';" class="button1">Home Page</button>
