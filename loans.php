    ...
    <div class="pt-20">
      ...
      <div class="spe">
                  ...
                  <div class="row">
                    ...
                    <div class="content6">
                      <h2 class ="t1">Here to provide mortgage options for you</h2>
                    <p class="t2">We're more flexible than the banks, credit unions, and private money lenders we're WheneverHome.</p>
                    <button onClick="window.location.href='mortgage.php';" class="button1">Apply</button>
                  </div>
                  <div class="content6">
                    <img class="img" src="mortgage.png">
                  </div>
                  </div>
                  <div class="content4">
                    <div class="content6">
                      <img class="img" src="auto.png">
                  </div>
                  <div class="content6">
                    <h2 class ="t1">Here to provide auto loan options for you</h2>
                    <p class="t2">We're more flexible than the banks, credit unions, and private money lenders we're WheneverHome.</p>
                    <button onClick="window.location.href='auto.php';" class="button1">Apply</button>
                  </div>
