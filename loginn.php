            ...
            <div class="content4">
              <div>
                  <section class="signup-form">
                    ...
                    <button type="submit" name="submit">Login</buttton>
        ...
        <div class="w-full flex flex-col md:flex-row py-6">
          ...
          <div class="flex-1">
            ...
            <ul class="list-reset mb-6">
              ...
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="coming soon page.php" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Privacy</a>
              </li>
            </ul>
          </div>
          <div class="flex-1">
